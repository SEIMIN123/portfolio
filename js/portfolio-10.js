...
// const content =
//   "이로써 저의 포트폴리오는 끝이 났습니다.``아직 부족한 실력입니다만 그래도 포기하지 않고 열심히 달려가보겠습니다.`어려운 직업이라고 생각합니다만 ``그만큼 매력적이라고 생각하기 때문에 한단계, 한단계 밟아가며 틀을 깨는 사람이 되겠습니다.``저의 포트폴리오를 함께 해주셔서 감사합니다!`"
