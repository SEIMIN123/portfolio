...
const content ="이로써 저의 포트폴리오는 끝이 났습니다.``짧다면 짧고 길다면 긴 반년, 6개월동안 ``좋은 강사님을 만나서 많은 것을 배웠습니다.``다 같이 고생한 학생분들도, ``특히 더 고생하셨던 공욱재 강사님도 ``모두 다 잘되고 더 잘되서 ``어디선가 다시 보는 날이 오면 좋겠습니다.``모두 고생하셨고 좋은날만 있기를 진심으로 바랍니다.``그리고 저의 포트폴리오를 함께 해주셔서 감사합니다.`"
