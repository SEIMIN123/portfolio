...
const content ="이로써 저의 포트폴리오는 끝이 났습니다.``아직 배울 것이 많고 부족합니다만 `그래도 포기하지 않고 열심히, 그리고 잘하는, `디자이너가 되보려 합니다.``쉬운 직업은 없다고 생각합니다. ``그만큼 웹디자인이라는 직업이 저에겐 `매력적으로 다가왔기 때문에 `한단계, 한단계 밟아가며 `더 성장하는 사람이 되게끔 잘 할 것입니다.``지금까지 저의 포트폴리오를 함께 해주셔서 감사합니다.`"
